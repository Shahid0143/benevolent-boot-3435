  ...
  return (
    <Box style={{backgroundColor:"rgb(51,51,51)"}}
      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        <Img   margin="auto" width="30%" backgroundColor="white" src='https://columbia.scene7.com/is/image/ColumbiaSportswear2/20590_C_U_X1_SU20_CGR_HP_Banner_Black_Logo_resized_@2x?$aem_png$'></Img>
        <Text style={{textAlign:"center"}}>join the adventure</Text>
        <Text style={{textAlign:"center",marginBottom:"90px"}}>Get free ground and rewards on every purchase, plus other exclusive benefits</Text>
        <SimpleGrid
          templateColumns={{ sm: '1fr 1fr', md: '2fr 1fr 1fr 2fr' }}
          spacing={8}>
          <Stack spacing={6}>
            <Text fontSize={'sm'}>
              © 2022 SASTA BAZZAR. All rights reserved
            </Text>
          ...
          <Stack align={'flex-start'}>
            ...
            <Link href={'#'}>Tough Mother Outdoor Guide</Link>
            <Link href={'#'}>History</Link>
            <Link href={'#'}>Columbia Greater Rewards Program</Link>
            <Link href={'#'}>Corporate Responsibility</Link>
            <Link href={'#'}>Investor Relations</Link>
            <Link href={'#'}>Press Center</Link>
            <Link href={'#'}>Careers</Link>
            <Link href={'#'}>Affiliate Program</Link>
            <Link href={'#'}>Product Testing</Link>
            <Link href={'#'}>Become a Business Partner</Link>
            <Link href={'#'}>Digital Media Resources</Link>
          </Stack>
          <Stack align={'flex-start'}>
            <ListHeader>Shop</ListHeader>
            <Link href={'#'}>Shop By Activity</Link>
            <Link href={'#'}>Shop By Technology</Link>
            <Link href={'#'}>Returns</Link>
            <Link href={'#'}>Warranty</Link>
            <Link href={'#'}>Product Care</Link>
            <Link href={'#'}>Accessibility</Link>
            <Link href={'#'}>Special Deals</Link>
            <Link href={'#'}>Professional Purchase</Link>
            <Link href={'#'}>Size Guides</Link>
          </Stack>
          <Stack align={'flex-start'}>
            <ListHeader>CONNECT WITH US</ListHeader>
            <Text>Subscribe and be the first to hear about new products, sales, and more.</Text>
            <Stack paddingTop={'35px'} direction={'row'}>
              <Input
            ...
            <Stack  paddingTop={'70px'} >
            <ListHeader >CUSTOMER CARE</ListHeader>
            <Text>Phone: 5am-8pm PT Mon-Fri, Closed Sat/Sun
                 Chat: 5am-8pm PT Sat/Sun, 4am-9pm PT Mon-Fri
                 Due to extreme weather, we are receiving higher than expected call volumes and long wait times. For faster service, please use chat which can be found on the bottom right corner of the website.</Text>
